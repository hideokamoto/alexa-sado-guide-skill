const facts = {
  ...
  '千利休': '1500年代後半の茶人。わび茶の完成者として知られ、茶聖ともよばれています。',
  '古田織部': '1600年代の戦国武将。大胆かつ自由な気風を好み、「織部好み」と呼ばれる一大流行を安土桃山時代にもたらしました。',
  '茶碗': '茶の湯において用いられる茶を入れて飲むための碗を指す言葉。産地や由来、その色形の特徴によって様々な種類がります。',
  '茶室': '茶道において、茶を出してもてなすために造られる施設である。草庵風のものと書院風のものがあり、一般的には草庵風のものさします。',
...
exports.getRandomFacts = getRandomFacts
exports.getFacts = getFacts
exports.AskFact = AskFact
